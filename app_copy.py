...
# Suggested actions based on segment
segment_treatments = {
...
if st.button("Predict Segment"):
    if total_spent == 0 and n_transaction == 0 and day_since_last_visit == 0 and median_days == 0:
        ...
        # Display segment description and treatment suggestions
        st.markdown(f"**Segment Description**: {segment_descriptions[predicted_label]}")
        st.markdown(f"**Suggested Action**: {segment_treatments[predicted_label]}")
